---
name: frontend-to-ir
description: Lower a toy language AST to LLVM 22 IR using IRBuilder. Covers project setup, AST node types, expression lowering, control flow, functions, structs, and applying mem2reg.
---

# Skill: Lower a Language Frontend to LLVM IR (LLVM 22)
