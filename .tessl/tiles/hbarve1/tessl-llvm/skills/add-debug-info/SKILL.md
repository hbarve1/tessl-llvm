---
name: add-debug-info
description: Add DWARF debug info to an existing LLVM 22 IR frontend. Covers DIBuilder setup, compile unit, function subprograms, local variable declarations, source locations on instructions, and module flags.
---

# Skill: Add Debug Info to an LLVM Frontend (LLVM 22)
