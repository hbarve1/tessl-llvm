---
name: jit-setup
description: Set up an ORC JIT v2 execution engine for a language runtime using LLVM 20. Covers LLJIT, LLLazyJIT, ThreadSafeModule, symbol exposure, optimization pipeline, and calling JIT'd functions.
---

# Skill: Set Up an ORC JIT v2 Engine (LLVM 20)
...
- **Do NOT** use MCJIT — it is deprecated; ORC v2 (`LLJIT`/`LLLazyJIT`) is the correct API in LLVM 20.
